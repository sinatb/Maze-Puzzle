...
namespace Interactables
{
    ...
    {
        [FormerlySerializedAs("_interactionName")] [SerializeField] private string interactionName = "Press E to Open Door";
        ...
        private void OnPuzzleDone()
        {
            ...
            {
                var chances = _puzzleManager.ReduceChances();
                if (chances <= 0)
                {
                    _isLocked = true;
                    interactionName = "The Door Is Locked";
